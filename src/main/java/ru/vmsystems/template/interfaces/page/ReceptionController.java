...
import static ru.vmsystems.template.interfaces.page.URLS.PAGE_REDIRECT_TO_RECEPTIONS;

@Controller
@RequestMapping("glass/reception")
public class ReceptionController extends BackService {

    private static final Logger LOG = LoggerFactory.getLogger(ReceptionController.class);

    private static final String PAGE = "glass/reception/receptions";
    private static final String PAGE_REDIRECT = PAGE_REDIRECT_TO_RECEPTIONS;

    @Autowired
    private ReceptionOfOrderService service;
    ...
    public String create(@ModelAttribute(value = "type") ReceptionOfOrderDto dto) {
        service.create(dto);
    ...
    public String update(@PathVariable(value = "id") Long id,
                         @ModelAttribute(value = "type") ReceptionOfOrderDto dto) {
