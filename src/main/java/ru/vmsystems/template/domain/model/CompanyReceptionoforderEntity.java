...
public class CompanyReceptionoforderEntity {
    ...
    public boolean equals(Object o) {
        ...
        CompanyReceptionoforderEntity that = (CompanyReceptionoforderEntity) o;

        if (id != null ? !id.equals(that.id) : that.id != null) return false;
        if (name != null ? !name.equals(that.name) : that.name != null) return false;
        if (orderNumPrefix != null ? !orderNumPrefix.equals(that.orderNumPrefix) : that.orderNumPrefix != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (orderNumPrefix != null ? orderNumPrefix.hashCode() : 0);
