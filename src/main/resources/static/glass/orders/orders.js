...
module.exports = {"layout":"layout-eckJb"};
...
var DataTable = function (_React$Component) {
  ...
  _createClass(DataTable, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'table',
        { className: _index2.default['data-table'] },
        this.props.children
      );
    }
  }]);
...
DataTable.HeaderCell = function (props) {
  return _react2.default.createElement(
    'th',
    { className: _index2.default.cell + ' ' + _index2.default.cell_header },
    props.children
  );
};

DataTable.HeaderRow = function (props) {
  return _react2.default.createElement(
    'tr',
    { className: _index2.default.row + ' ' + _index2.default.row_header },
    props.children
  );
};
...
DataTable.Cell = function (props) {
  return _react2.default.createElement(
    'td',
    { className: (0, _classnames2.default)(_index2.default.cell, props.className) },
    props.children
  );
};
...
var tableMeta = {
  columnsOrder: ['number', 'updateDate', 'client', 'receptionOfOrder', 'count', 'discountSum']
};

var orderMeta = {
  columnsOrder: ['creationDate', 'updateDate', 'client', 'accountNumber', 'receptionOfOrder', 'count', 'summa', 'discount', 'discountSum']
};

module.exports = { ordersMeta: ordersMeta, tableMeta: tableMeta, orderMeta: orderMeta };
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          { className: _index2.default['header-menu'] },
          _react2.default.createElement(
            'li',
            { className: _index2.default['menu-item'] },
            '\u0417\u0430\u043A\u0430\u0437\u044B'
          ),
          _react2.default.createElement(
            'li',
...
var OrdersTable = function (_React$Component) {
  ...
  _createClass(OrdersTable, [{
    ...
    value: function componentDidMount() {
      ...
      _api2.default.getOrders().then(function (orders) {
